...
Функция КодыОтветаHTTP() Экспорт
	...
	Возврат HTTPStatusCodeServer.КодыОтветаHTTP();

КонецФункции

Функция ИдентификаторыКодовОтветаHTTP() Экспорт
	
	Возврат HTTPStatusCodeServer.ИдентификаторыКодовОтветаHTTP();
	
КонецФункции

Функция ОписанияКодовОтветаHTTP() Экспорт
	
	Возврат HTTPStatusCodeServer.ОписанияКодовОтветаHTTP();
